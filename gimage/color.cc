...
void getTurboValue(uint8_t &r, uint8_t &g, uint8_t &b, float v)
{
  ...
  r=static_cast<uint8_t>((turbo_srgb[v0][0]*v0f+turbo_srgb[v1][0]*v1f)>>8);
  g=static_cast<uint8_t>((turbo_srgb[v0][1]*v0f+turbo_srgb[v1][1]*v1f)>>8);
  b=static_cast<uint8_t>((turbo_srgb[v0][2]*v0f+turbo_srgb[v1][2]*v1f)>>8);
}
